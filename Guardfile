...
guard :rubocop, all_on_start: false, cli: %w[--format html -o ./public/rubocop.html] do
end

guard :process, name: "swaggerize", command: "rake rswag:specs:swaggerize" do
  watch(%r{^spec/integration/(.+)\.rb$})
  watch(%r{^config/initializers/rswag-(.+)\.rb$})
end
